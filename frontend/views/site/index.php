...
<div class="slider-area pb-60">
    <div class="slider-wrapper theme-default  nivo2">
        ...
        <div id="slider" class="nivoSlider">
            <a href="shop.html"><img src="img/slider/3.jpg" data-thumb="img/slider/3.jpg" alt=""
                                     title="#slider-1-caption1"/></a>
            <a href="shop.html"><img src="img/slider/4.jpg" data-thumb="img/slider/4.jpg" alt=""
            ...
            <div class="text-content-wrapper">
                <div class="container">
                    <div class="text-content">
                        <h4 class="title2 wow bounceInLeft mb-16" data-wow-duration="2s" data-wow-delay="0s">Big
                            Sale</h4>
            ...
            <div class="text-content-wrapper">
                <div class="container">
                    <div class="text-content slide-2">
                        <h4 class="title2 wow bounceInLeft mb-16" data-wow-duration="1s" data-wow-delay="1s">Big
                            Sale</h4>
                        <h1 class="title1 wow flipInX  mb-16" data-wow-duration="1s" data-wow-delay="2s">Hand Tools <br>Circular
                            Saw & Power Saw</h1>
            ...
            <div class="double-pro">
                ...
                <div class="single-product">
                    ...
                    <div class="pro-content">
                        ...
                        <h4><a href="product.html">Products Name Here</a></h4>
                        <p><span class="price">$150.00</span>
                            <del class="prev-price">$200.00</del>
                        </p>
                    </div>
                </div>
                <!-- Single Product End -->
        ...
        <div class="blog-active owl-carousel">
            ...
            <div class="single-blog">
                ...
                <div class="blog-content">
                    <h4 class="blog-title"><a href="blog-details.html">Lorem ipsum dolor sit amet, consectl adip elit,
                            sed do eiusmod tempor</a></h4>
                    <div class="blog-meta">
                        <ul>
...
<?=
\frontend\widgets\Cart::widget([
    'action_add' => '/cart/add',
    'action_delete' => '/cart/delete',
    'action_all' => '/cart/all',
    'button_add' => '.add-cart',
    'data_attr' => 'data-product-add',
